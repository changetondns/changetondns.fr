...
<script>
export default {
  props: ['plateforme', 'theme'],

  methods: {
    emitClick(event) {
      this.$emit('show_image', event.target.src)
    }
  }
}
</script>
  ...
  <div class="p-4 md:p-6">
    <section v-if="plateforme === 'w-10'">
      ...
      <ol class="list-decimal text-[#2E2E2E] mt-12 mx-2 md:mx-8" :class="{ 'text-[#FFFFFF]': !theme }">
        <li class="mt-10">
          ...
          <img class="w-auto mx-auto my-10 object-contain" src="/window10/reseau_internet.png" @touchstart="emitClick($event)"/>
        </li>
        <li class="mt-10">
          ...
          <img class="w-auto mx-auto my-10 object-contain" src="/window10/adapter_settings.png" @touchstart="emitClick($event)"/>
        </li>
        <li class="mt-10">
          ...
          <img class="w-auto mx-auto my-10 object-contain" src="/window10/Properties.png" @touchstart="emitClick($event)"/>
        </li>
        <li>
        ...
        <li class="mt-10">
          ...
          <img class="w-auto mx-auto my-10 object-contain" :src="'/window10/IPV4.png'" @touchstart="emitClick($event)"/>
        </li> 
        <li class="mt-10">
          ...
          <img class="w-auto mx-auto my-10 object-contain" :src="'/window10/dns.png'" @touchstart="emitClick($event)"/>
        </li> 
        <li class="mt-10">
        ...
        <li class="mt-10">
          ...
          <img class="w-auto mx-auto my-10 object-contain" :src="'/window10/IPV6.png'" @touchstart="emitClick($event)"/>
        </li> 
        <li class="mt-10">
          ...
          <img class="w-auto mx-auto my-10 object-contain" :src="'/window10/dnsV6.png'" @touchstart="emitClick($event)"/>
        </li> 
        <li>
    ...
    <section v-if="plateforme === 'w-11'">
      ...
      <ol class="list-decimal text-[#2E2E2E] mt-12 mx-2 md:mx-8" :class="{ 'text-[#FFFFFF]': !theme }">
        <li class="mt-10">
          Rendez-vous dans les paramètres de votre système (touche Windows + i) puis cliquez sur <span class="italic underline">Réseau et Internet</span>.
          <img class="w-auto mx-auto my-10 object-contain" :src="'/window11/reseau_internet.png'" @touchstart="emitClick($event)"/>
        </li>
        <li class="mt-10">
            Choisissez le réseau que vous utilisez <span class="italic underline">(Wi-Fi / Ethernet)</span>.
          <img class="w-auto mx-auto my-10 object-contain" :src="'/window11/wifi_ethernet.png'" @touchstart="emitClick($event)"/>
        </li>
        <li class="mt-10">
          Cliquez sur <span class="italic underline">Propriétés du matériel</span>.
          <img class="w-auto mx-auto my-10 object-contain" :src="'/window11/matériel_prop.png'" @touchstart="emitClick($event)"/>
        </li>
        <li class="mt-10">
          Cliquez sur <span class="italic underline">Modifier</span> dans la partie attribution du serveur DNS.
          <img class="w-auto mx-auto my-10 object-contain" :src="'/window11/modifier_dns.png'" @touchstart="emitClick($event)"/>
        </li>
        <li class="mt-10">
          ...
          <img class="w-auto mx-auto my-10 object-contain" :src="'/window11/Manuel.png'" @touchstart="emitClick($event)"/>
        </li>
        <li class="mt-10">
            Activez le boutton <span class="italic underline">IPv4</span> et rentrez les addresses IP des DNS que vous avez choisi.
          <img class="w-auto mx-auto my-10 object-contain" :src="'/window11/dns_IPv4.png'" @touchstart="emitClick($event)"/>
        </li>
        <li class="mt-10">
          Faites de même pour <span class="italic underline">l’IPv6</span>  si vous le souhaitez.
          <img class="w-auto mx-auto my-10 object-contain" :src="'/window11/dns_IPv6.png'" @touchstart="emitClick($event)"/>
        </li>
        <li>
    ...
    <section v-if="plateforme === 'android-new'">
      ...
      <ol class="list-decimal text-[#2E2E2E] mt-12 mx-2 md:mx-8" :class="{ 'text-[#FFFFFF]': !theme }">
        <li class="mt-10">
          ...
          <img class="w-auto mx-auto my-10 object-contain max-h-[46rem]" :src="'/android new/main_settings.png'" @touchstart="emitClick($event)"/>
        </li>

        <li class="mt-10">
          Sélectionnez <span class="italic underline">DNS privé</span>.
          <img class="w-auto mx-auto my-10 object-contain max-h-[46rem]" :src="'/android new/dns_settings.png'" @touchstart="emitClick($event)"/>
        </li>

        <li class="mt-10">
          Sélectionnez ensuite <span class="italic underline">Nom d’hote du fournisseur de DNS privé</span>.
          <img class="w-auto mx-auto my-10 object-contain max-h-[46rem]" :src="'/android new/dns.png'" @touchstart="emitClick($event)"/>
        </li>

        <li class="mt-10">
          Entrez le nom d'hôte du DNS, voici une liste de noms d'hôtes correspond au fournisseur DNS du tableau :<br /><br />
    ...
    <section v-if="plateforme === 'mac'">
      ...
      <ol class="list-decimal text-[#2E2E2E] mt-12 mx-2 md:mx-8" :class="{ 'text-[#FFFFFF]': !theme }">
        ...
        <li class="mt-10">
          ...
          <img class="w-auto mx-auto my-10 object-contain" :src="'/mac/reglage_system.jpg'" @touchstart="emitClick($event)"/>
        </li>
        <li class="mt-10">
          Cliquez sur un service réseau que vous utilisez (Wi-Fi ou Ethernet) à droite.
          <img class="w-auto mx-auto my-10 object-contain" :src="'/mac/select_reseaux.jpg'" @touchstart="emitClick($event)"/>
        </li>
        <li class="mt-10">
        ...
        <li class="mt-10">
          ...
          <img class="w-auto mx-auto my-10 object-contain" :src="'/mac/dns.png'" @touchstart="emitClick($event)"/>
        </li>
        <li class="mt-10">
    ...
    <section v-if="plateforme === 'android-old'">
      ...
      <ol class="list-decimal text-[#2E2E2E] mt-12 mx-2 md:mx-8" :class="{ 'text-[#FFFFFF]': !theme }">
        ...
        <li class="mt-10">
          ...
          <img class="w-auto mx-auto my-10 object-contain" :src="'/android_old/advanced_option.png'" @touchstart="emitClick($event)"/>
        </li>
        <li class="mt-10">
          Changez les paramètres IP en statique.
          <img class="w-auto mx-auto my-10 object-contain" :src="'/android_old/ip_static.png'" @touchstart="emitClick($event)"/>
        </li>
        <li class="mt-10">
          Ajoutez l’adresse IPv4 du DNS que vous souhaitez et cliquez sur <span class="italic underline">Enregistrez</span>.
          <img class="w-auto mx-auto my-10 object-contain" :src="'/android_old/dns.png'" @touchstart="emitClick($event)"/>
        </li>
        <li class="mt-10">
    ...
    <section v-if="plateforme === 'ios'">
      ...
      <ol class="list-decimal text-[#2E2E2E] mt-12 mx-2 md:mx-8" :class="{ 'text-[#FFFFFF]': !theme }">
        ...
        <li class="mt-10">
          ...
          <img class="w-auto mx-auto my-10 object-contain" :src="'/ios/i.png'" @touchstart="emitClick($event)"/>
        </li>
        ...
        <li class="mt-10">
          ...
          <img class="w-auto mx-auto my-10 object-contain" :src="'/ios/add_server.png'" @touchstart="emitClick($event)"/>
        </li>
